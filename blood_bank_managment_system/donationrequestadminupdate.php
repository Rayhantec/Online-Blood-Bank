...
$sql="update `donationtable` set id=$id,username='$username',email='$email',mobile='$mobile',bloodtype='$bloodtype',illness='$illness',medication='$medication',donationdate='$donationdate' where id=$id";
$result=mysqli_query($con,$sql);
if($result){
...
<body>
    ...
    <form method="post">
        ...
        <input type="date" name="donationdate" value=<?php echo $donationdate; ?>>
